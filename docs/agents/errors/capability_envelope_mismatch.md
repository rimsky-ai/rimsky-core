...
The operator-declared `write_semantics_envelope` for a claim producer is not a subset of the envelope the producer advertised at startup via `Capabilities()`. Rimsky refuses to start.
