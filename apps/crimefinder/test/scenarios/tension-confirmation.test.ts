...
describe("scenario: tension confirmation routing", () => {
  it("writes a tension_confirmation row instead of a finding when tension_slug is open", async () => {
      ...
      const r = await handleAppendFinding(
        {
          ...
          description: "this surfaces again",
          tension_slug: "example-tension",
          confidence: "high",
        },
        stateDeps,
      );
