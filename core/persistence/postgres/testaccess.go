...
// CoordinatorFromPoolForTest wraps a *pgxpool.Pool as a
// persistence.Coordinator. Test-only.
func CoordinatorFromPoolForTest(pool *pgxpool.Pool) persistence.Coordinator {
	return newCoordinator(pool)
}
