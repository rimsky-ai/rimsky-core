...
// per-feature aspect impls. Fully wired: Coordinator(), Store(), and
...
func (d *driver) Coordinator() persistence.Coordinator {
	if d.c == nil {
		return nil
	}
	return d.c
...
func (d *driver) Migrate(ctx context.Context, log shared.Logger) error {
	if d.c == nil {
		return errors.New("sqlite driver: coordinator not initialized")
	}
