...
func TestRunTagCreate_OK(t *testing.T) {
	srv := setupClitest(t)
	hash, _ := srv.State.RegisterTemplate(map[string]any{"name": "x", "version": "1.0", "frame_resolution": "coalesce", "nodes": []any{}}, "", "")
...
func TestRunTagList(t *testing.T) {
	srv := setupClitest(t)
	hash, _ := srv.State.RegisterTemplate(map[string]any{"name": "x", "version": "1.0", "frame_resolution": "coalesce", "nodes": []any{}}, "v1", "")
...
func TestRunTagMv_OK(t *testing.T) {
	srv := setupClitest(t)
	hash, _ := srv.State.RegisterTemplate(map[string]any{"name": "x", "version": "1.0", "frame_resolution": "coalesce", "nodes": []any{}}, "v1", "")
	hash2, _ := srv.State.RegisterTemplate(map[string]any{"name": "y", "version": "1.0", "frame_resolution": "coalesce", "nodes": []any{}}, "", "")
...
func TestRunTagRm_OK(t *testing.T) {
	srv := setupClitest(t)
	srv.State.RegisterTemplate(map[string]any{"name": "x", "version": "1.0", "frame_resolution": "coalesce", "nodes": []any{}}, "v1", "")
