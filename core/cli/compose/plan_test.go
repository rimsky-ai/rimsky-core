...
func TestComputePlan_TagMv(t *testing.T) {
	...
	oldHash, _ := srv.State.RegisterTemplate(map[string]any{"name": "old", "version": "1.0", "frame_resolution": "coalesce", "nodes": []any{}}, "compose:p:a@1.0", "")
...
func TestComputePlan_RemoveFromManifest(t *testing.T) {
	...
	defer srv.Close()
	c := cli.NewClient(srv.URL)
	hash, _ := srv.State.RegisterTemplate(map[string]any{"name": "x", "version": "1.0", "frame_resolution": "coalesce", "nodes": []any{}}, "compose:p:legacy@0.9", "")
...
func TestComputePlan_NonTerminalOrphan(t *testing.T) {
	...
	defer srv.Close()
	c := cli.NewClient(srv.URL)
	hash, _ := srv.State.RegisterTemplate(map[string]any{"name": "x", "version": "1.0", "frame_resolution": "coalesce", "nodes": []any{}}, "compose:p:a@1.0", "")
	srv.State.SetTemplateState(hash, "deployed")
