...
`.ok-workspaces/ceremony/document.md`; the ceremony reads it there
when `.ok-workspaces/` exists.

## Requires

Nothing. This family governs workspace hygiene — worktrees, runtime
isolation, per-run artifact tags — none of which is user-facing
...
- Contributes nothing to the catalog, the synthesis box, or the
  assessments.
