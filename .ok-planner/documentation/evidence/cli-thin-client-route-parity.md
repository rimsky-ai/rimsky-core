...
release: d977250c
---
# Evidence set — because the CLI is a thin pass-through client, every CLI verb corresponds to a control-API route and every route is reachable from some CLI verb.

Source of the prior: published-concept — `concept:rimsky` ("a thin HTTP+JSON client over the control-api", "no client-side business logic")

## What the audit ran and observed (assumption record)

`.ok-planner/experiments/assumption-cli-thin-client-route-parity` — built for
...
## Experiment record (experiment:assumption-cli-thin-client-route-parity)
...
Runnables: `src:.ok-planner/experiments/assumption-cli-thin-client-route-parity/` at the stamped commit.
