...
release: d977250c
demonstration: experiment:assumption-dispatch-defaults-cover-every-node-timing-key
---
## Assumption
...
the experiment
— built for this run — booted one container per key, mounting a the experiment
...
`dispatch_defaults.max_retries` to a working the experiment has a deployment
