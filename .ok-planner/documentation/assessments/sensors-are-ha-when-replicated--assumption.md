---
assessment: sensors-are-ha-when-replicated--assumption
subject: assumption:sensors-are-ha-when-replicated
way: assumption
release: d977250c
outcome: held
warrant: experiment:assumption-sensors-are-ha-when-replicated
---
