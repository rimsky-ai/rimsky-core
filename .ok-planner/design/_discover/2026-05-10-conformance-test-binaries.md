...
- `cmd/rimsky-conformance/main.go` — executor conformance binary (113 lines).
- `cmd/rimsky-conformance/observability_check.go` — `--check-observability` probe.
- `cmd/rimsky-conformance/lifecycle_check.go` — `--check-lifecycle` probe.
