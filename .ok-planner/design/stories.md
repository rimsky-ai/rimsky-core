...
Read first. Then read `stories/<slug>.md` for the full body. Refreshed by sprint execution when a sprint's corpus deltas touch `stories/`. Do not edit by hand — changes will be overwritten.
