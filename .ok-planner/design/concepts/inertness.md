...
- **Substitution-leaf path walk** — traverses every inert stream at substitution time (claim payload, attribute values, message payloads) to extract the leaf value named by a substitution path.
