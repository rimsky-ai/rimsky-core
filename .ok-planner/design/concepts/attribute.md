...
- 2026-05-24 — Matcher grammar (the closed 5-key dispatch-identity predicate from by_match) extracts to foundation/matcher/ per spec 2026-05-24-instance-debugger-design. concept:breakpoint reuses the package. by_match wire shape, semantics, and merge layering unchanged.
