...
- Cancellation: the cancel endpoint marks the operation cancelled. Pending undelivered messages are skipped (a cancelled filter on the pending-delivery path); in-flight frames complete normally (no preemption).
