...
- The async-callback deferral registers a callback identifier and the eventual settling terminal arrives via a later callback addressed to that identifier.
