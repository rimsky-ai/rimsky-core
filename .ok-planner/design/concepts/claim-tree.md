...
- The parent's aggregation counters (expected, committed, and abandoned child counts) are claimant-guarded — bumped only by the supervisor that holds the parent. See invariant 4.
