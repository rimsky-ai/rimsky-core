...
Bundled webhook sensor publisher: HTTP route exposure under a configured path-prefix; inbound POST translated to message into the target instance; acknowledgment after rimsky has persisted the message.
