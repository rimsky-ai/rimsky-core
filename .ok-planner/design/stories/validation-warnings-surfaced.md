...
Both the register handler and the validate endpoint merge the static validator's warnings into the responses' validation-warnings field, and the warnings-as-errors flag trips on them when set.
