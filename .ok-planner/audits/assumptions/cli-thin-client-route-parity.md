---
assumption: cli-thin-client-route-parity
commit: d977250c
disposition: trap
synthesized: 2026-08-16T05:48:16Z
---

# because the CLI is a thin pass-through client, every CLI verb corresponds to a control-API route and every route is reachable from some CLI verb.
...
cross-map the 93 CLI verbs against the 92 HTTP routes and name the routes with no verb and the verbs with no route.
