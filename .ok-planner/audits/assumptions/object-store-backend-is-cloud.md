---
assumption: object-store-backend-is-cloud
commit: d977250c
disposition: trap
synthesized: 2026-08-16T05:48:16Z
---

# `object-store: backend` names a cloud object store — S3, GCS, Azure Blob — not only a local filesystem path.
...
set `backend: s3` with a bucket and see whether the sensor boots and polls.
