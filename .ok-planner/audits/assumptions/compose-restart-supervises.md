---
assumption: compose-restart-supervises
commit: d977250c
disposition: trap
synthesized: 2026-08-16T05:48:16Z
---

# `instances[].restart` means the compose runtime re-creates or restarts an instance when it terminates, the way a container restart policy does.
...
declare `restart` on an instance, force-terminate it, and see whether compose re-creates it.
