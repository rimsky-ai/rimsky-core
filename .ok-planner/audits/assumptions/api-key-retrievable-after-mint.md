---
assumption: api-key-retrievable-after-mint
commit: d977250c
disposition: trap
synthesized: 2026-08-16T05:48:16Z
---

# `rimsky auth show` or `GET /v1/auth/keys/{nameOrID}` can return the key material again, since both a show verb and a get route exist.
...
mint a key, then read it back through both surfaces and check whether plaintext appears.
