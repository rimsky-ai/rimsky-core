---
assumption: http-events-streamable
commit: PENDING
disposition: trap
synthesized: 2026-08-16T05:48:16Z
---

# `GET /v1/events` supports a streaming/follow mode (SSE or long-poll), because the CLI offers `rimsky watch` and a `--follow` flag.
...
request `/v1/events` with a follow parameter or `Accept: text/event-stream` and see whether the connection stays open and emits.
