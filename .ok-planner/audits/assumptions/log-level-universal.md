---
assumption: log-level-universal
commit: d977250c
disposition: trap
synthesized: 2026-08-16T05:48:16Z
---

# `RIMSKY_LOG_LEVEL` is honored by all eight binaries and all eleven bundled service images, with the same level vocabulary.
...
boot each core binary and each bundled service with `RIMSKY_LOG_LEVEL=debug` and check log verbosity changes in every one.
