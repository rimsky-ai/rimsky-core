---
assumption: cli-destructive-verbs-confirm
commit: d977250c
disposition: trap
synthesized: 2026-08-16T05:48:16Z
---

# destructive verbs (`rm`, `delete`, `revoke`, `undeploy`, `admin reset`, `lineage prune`) prompt for confirmation interactively, and `--yes` is what suppresses the prompt.
...
run each destructive verb without `--yes` on a TTY and see whether anything is asked before the mutation lands.
