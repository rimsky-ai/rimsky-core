---
assumption: mcp-standard-methods-present
commit: d977250c
disposition: trap
synthesized: 2026-08-16T05:48:16Z
---

# the server implements the rest of the base MCP method set — `ping`, `prompts/list`, `resources/subscribe`, `notifications/*` — beyond the five listed.
...
issue `ping`, `prompts/list`, and `resources/subscribe` over the MCP endpoint and record the responses.
