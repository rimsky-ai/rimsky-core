---
assumption: http-tag-create-idempotent
commit: PENDING
disposition: trap
synthesized: 2026-08-16T05:48:16Z
---

# creating a tag or registering a template that already exists returns success rather than a conflict, the same way re-creating an instance under an existing key does.
...
`POST /v1/tags` and `POST /v1/templates` twice with identical bodies and compare the second response's status.
