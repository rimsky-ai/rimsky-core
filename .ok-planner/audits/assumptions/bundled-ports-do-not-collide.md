---
assumption: bundled-ports-do-not-collide
commit: d977250c
disposition: trap
synthesized: 2026-08-16T05:48:16Z
---

# every bundled service's default port is distinct, so the eleven service images plus the core stack come up together with no port configuration.
...
start all fifteen images with default ports on one network namespace and record any bind failure.
