...
(Module: `pkg:github.com/rimsky-ai/rimsky-core/foundation`. Owns: cascade engine, claim/lock primitives + persistence ledgers, integration runner + sweeps, foundation persistence drivers.)
...
(Module: `pkg:github.com/rimsky-ai/rimsky-core/protocols`. Owns: gRPC service protocol Go interfaces + .proto sources + generated bindings. Stdlib + grpc + protobuf only.)
...
(Module: `pkg:github.com/rimsky-ai/rimsky-core`. Owns: templates, instances, frames, scheduling, control-api, attributes, quality rules.)
...
| Surface | Citation |
|---|---|
| Module | `` `pkg:github.com/rimsky-ai/rimsky-core/mcp-servers/control-api` `` |
