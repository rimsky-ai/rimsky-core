...
- **Implemented:** `code:foundation/signal/audit/audit.go` lives in subpackage `audit`. Callers import as `signalaudit "github.com/fallguy/rimsky/foundation/signal/audit"` and invoke `signalaudit.EmitSignal(...)`.
