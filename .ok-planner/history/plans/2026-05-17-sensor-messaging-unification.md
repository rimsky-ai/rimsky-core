...
1. Find the `pgx-isolation` depguard rule. Extend its allow-list to include:
   - `github.com/fallguy/rimsky/sensors/sensor-http`
   - `github.com/fallguy/rimsky/sensors/sensor-object-store`
   - `github.com/fallguy/rimsky/sensors/sensor-webhook`
