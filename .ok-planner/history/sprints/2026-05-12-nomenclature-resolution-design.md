...
- Every import statement across `cmd/`, `stores/`, `executors/`, `test/`, `mcp-servers/` referencing `github.com/rimsky-ai/rimsky-core/modeling/...`.
...
**Net structural change:** the three-Go-module architecture is preserved (`foundation/`, `protocols/`, root `github.com/rimsky-ai/rimsky-core`). What changes is the root module's internal directory organization. Concept count stays at 46.
