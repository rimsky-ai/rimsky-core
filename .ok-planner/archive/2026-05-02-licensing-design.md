...
- **Conformance suites** (`rimsky-executor-conformance`, `rimsky-store-conformance`, `rimsky-conformance-probe`). Authors run these against their own implementations to verify protocol conformance and fork them into their own CI.
...
| `core/cmd/rimsky-executor-conformance/`, `core/cmd/rimsky-store-conformance/`, `core/cmd/rimsky-conformance-probe/` | Conformance test suites. Authors fork these into their own CI. |
...
Rimsky is multi-licensed:
  ...
  1. Source files in the embedder layer are licensed under the Apache License,
     ...
     docs/history/2026-05-02-licensing-design.md §4.1.
  ...
  2. Source files in the orchestrator layer are dual-licensed:
     ...
     and is documented in docs/history/2026-05-02-licensing-design.md §4.2.
