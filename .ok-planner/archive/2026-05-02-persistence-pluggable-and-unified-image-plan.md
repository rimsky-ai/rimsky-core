...
- **Build & test commands.** Per `CLAUDE.md`:
  ...
  ```
- **Module path.** `github.com/fallguy/rimsky`; `go.mod` is at the repo root.
...
3. Create `core/persistence/postgres/migrate.go`:
   ...
   import (
       ...
       "github.com/fallguy/rimsky/core/persistence"
       "github.com/fallguy/rimsky/core/persistence/postgres/migrations"
   )
...
2. Replace the pgxpool init and the `migrations.Run` call with:
   ...
   import (
       "github.com/fallguy/rimsky/core/persistence"
       _ "github.com/fallguy/rimsky/core/persistence/postgres"  // wire init()
       // _ "github.com/fallguy/rimsky/core/persistence/sqlite"   // UNCOMMENT in Task 30
       // ... existing imports
   )
...
1. For each `main.go`:
   ...
   - Add `_ "github.com/fallguy/rimsky/core/persistence/postgres"` import to register the driver.
...
4. Create `migrate.go` mirroring the Postgres version:
   ...
   import (
       ...
       "github.com/fallguy/rimsky/core/persistence"
       "github.com/fallguy/rimsky/core/persistence/sqlite/migrations"
   )
