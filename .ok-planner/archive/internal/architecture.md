...
|---|---|---|---|
| `github.com/rimsky-ai/rimsky-core/foundation` | `foundation/` | Layer 1 | stdlib + `protocols` + minimal third-party (`pgx`, `uuid`, `modernc.org/sqlite`) |
| `github.com/rimsky-ai/rimsky-core/protocols` | `protocols/` | Layer 3 | stdlib + grpc + protobuf only |
| `github.com/rimsky-ai/rimsky-core` (root) | `.` | Layers 2 + 4 | `foundation` + `protocols` + stdlib |

External service authors who write a custom claim-producer or executor in Go import `github.com/rimsky-ai/rimsky-core/protocols` only — no transitive dependency on rimsky's persistence drivers, gRPC server scaffolding, or modeling code.
...
```
rimsky/                              # repo root
├── foundation/                      # Layer 1 — Go module github.com/rimsky-ai/rimsky-core/foundation
│   ├── go.mod
...
│
├── protocols/                       # Layer 3 — Go module github.com/rimsky-ai/rimsky-core/protocols
│   ├── go.mod
...
│       └── events.proto
│
├── modeling/                        # Layer 2 — root Go module github.com/rimsky-ai/rimsky-core
...
└── go.mod                           # Root module github.com/rimsky-ai/rimsky-core
```
...
- `github.com/rimsky-ai/rimsky-core/foundation` — minimal embedding for custom orchestrator integrations.
- `github.com/rimsky-ai/rimsky-core/protocols` — minimal dependency for external service authors.
- `github.com/rimsky-ai/rimsky-core` — full repo, including bundled services and cmd binaries.
