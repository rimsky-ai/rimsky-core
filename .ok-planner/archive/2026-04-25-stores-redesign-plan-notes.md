...
**Verification:**
- `grep -rn '"github.com/rimsky-ai/rimsky-core/core/resource' core/supervisor/commit.go` returns nothing (file no longer exists). Task brief verification step satisfied.
