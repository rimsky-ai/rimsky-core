...
// the filesystem store-service. The standard filesystem store maintains
// no template or instance metadata; every method returns success
// without side effects. Operators that need filesystem-side reactions
// (e.g. preallocating a per-template directory) can fork this package.
package lifecycle
