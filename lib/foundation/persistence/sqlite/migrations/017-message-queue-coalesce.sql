...
-- a legal token (SQLite CHECK-tightening requires a full table rebuild
-- which we skip pre-v1). No Go code writes 'queued' after this
-- migration; a future tightening migration can excise the token when
-- warranted.
