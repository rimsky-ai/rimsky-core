...
ALTER TABLE rimsky_lifecycle_outbox ADD COLUMN attempt_count INTEGER NOT NULL DEFAULT 0;
ALTER TABLE rimsky_lifecycle_outbox ADD COLUMN next_attempt_at TEXT NOT NULL DEFAULT '1970-01-01T00:00:00.000000000Z';
ALTER TABLE rimsky_lifecycle_outbox ADD COLUMN last_error TEXT NOT NULL DEFAULT '';
