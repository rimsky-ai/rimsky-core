...
func Suite(
	...
	t.Run("RunStateWritesIsolated", func(t *testing.T) {
		...
		t.Run("RemoveForNode", func(t *testing.T) { testRunStateWritesIsolated_RemoveForNode(t, factory(t)) })
	...
	t.Run("ScopeKeyedRunStateOpsIsolated", func(t *testing.T) {
		...
		t.Run("HasEarlierQueuedRoundFromSameSender", func(t *testing.T) { testScopeKeyedOps_HasEarlierQueuedRoundFromSameSender(t, factory(t)) })
		...
		t.Run("GetPriorCascadeQueuedNotClaimed", func(t *testing.T) { testScopeKeyedOps_GetPriorCascadeQueuedNotClaimed(t, factory(t)) })
	...
	t.Run("MessagesSenderSubjectRoundTrips", func(t *testing.T) { testMessagesSenderSubjectRoundTrips(t, factory(t)) })
	...
	t.Run("CascadeWalkerMethods", func(t *testing.T) {
		...
		t.Run("SetRunRequiredClaimProducersReusesStaleRun", func(t *testing.T) { testSetRunRequiredClaimProducers_ReusesStaleRun(t, factory(t)) })
	})
