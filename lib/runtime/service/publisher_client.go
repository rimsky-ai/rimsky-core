...
func DialPublisher(ctx context.Context, name, endpoint, tlsMode string) (*PublisherClient, error) {
	return DialPublisherWith(ctx, name, endpoint, tlsMode, ProcessClientCredentials())
}

func DialPublisherWith(_ context.Context, name, endpoint, tlsMode string, creds ClientCredentials) (*PublisherClient, error) {
