...
func (c *httpClient) Execute(ctx context.Context, req *genv1.ExecuteRequest) (*genv1.Outcome, string, error) {
	...
	principal := ""
	if p, err := pki.PrincipalFromVerifiedChains(resp.TLS); err == nil {
		principal = p
	}
