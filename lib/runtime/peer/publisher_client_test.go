...
func TestDialPublisher_TLSModeRequired_UsesTransportCredentials(t *testing.T) {
	...
	client, err := DialPublisher(context.Background(), "pub-mtls", endpoint, TLSModeRequired)
	if err != nil {
...
func TestDialPublisher_TLSModeOff_DoesNotSatisfyMTLSServer(t *testing.T) {
	...
	client, err := DialPublisher(context.Background(), "pub-plaintext", endpoint, TLSModeOff)
	if err != nil {
