...
| Variable | Read site |
| --- | --- |
| `RIMSKY_ALLOW_PLAINTEXT_ENROLLMENT` | `lib/protocols/serviceauth/config.go` |
...
| `RIMSKY_CONTROL_API_TOKEN` | `cmd/rimsky-host-daemon-proxy/config.go` |
| `RIMSKY_CONTROL_API_URL` | `cmd/rimsky-host-daemon-proxy/config.go` |
| `RIMSKY_DAEMON_ALLOW_PATHS` | `lib/runtime/hostdaemon/config.go` |
| `RIMSKY_DAEMON_HEARTBEAT_SEC` | `lib/runtime/hostdaemon/config.go` |
| `RIMSKY_DAEMON_IDENTITY_FILE` | `lib/runtime/hostdaemon/identity.go` |
| `RIMSKY_DAEMON_LABEL` | `lib/runtime/hostdaemon/config.go` |
| `RIMSKY_DAEMON_LISTEN` | `lib/runtime/hostdaemon/config.go` |
| `RIMSKY_DAEMON_PORT` | `lib/runtime/hostdaemon/spawn.go` |
| `RIMSKY_DAEMON_REAP_GRACE_SEC` | `lib/runtime/hostdaemon/config.go` |
| `RIMSKY_DAEMON_REGISTER_ACK_TIMEOUT_SEC` | `lib/runtime/hostdaemon/config.go` |
| `RIMSKY_DAEMON_ROUTING_LABEL` | `lib/runtime/hostdaemon/spawn.go` |
| `RIMSKY_DAEMON_STATUS_FILE` | `lib/runtime/hostdaemon/config.go` |
| `RIMSKY_DAEMON_TLS_CA` | `lib/runtime/hostdaemon/config.go` |
...
| `RIMSKY_HOST_DAEMON_INSECURE` | `cmd/rimsky-host-daemon-proxy/config.go` |
| `RIMSKY_HOST_DAEMON_PROXY_URL` | `lib/runtime/hostdaemon/config.go` |
| `RIMSKY_LOG_BINARY` | `cmd/internal/roleboot/roleboot.go` |
| `RIMSKY_LOG_LEVEL` | `cmd/rimsky-host-daemon-proxy/config.go` |
...
| `RIMSKY_PROXY_GRPC_PORT` | `cmd/rimsky-host-daemon-proxy/config.go` |
| `RIMSKY_PROXY_LOCAL_CA_FILE` | `cmd/rimsky-host-daemon-proxy/config.go` |
| `RIMSKY_PROXY_SERVICE_GRPC_PORT` | `cmd/rimsky-host-daemon-proxy/config.go` |
| `RIMSKY_PROXY_TLS_CERT` | `cmd/rimsky-host-daemon-proxy/config.go` |
| `RIMSKY_PROXY_TLS_KEY` | `cmd/rimsky-host-daemon-proxy/config.go` |
...
| `RIMSKY_SERVICE_AUTH` | `lib/protocols/enroll/mode.go` |
