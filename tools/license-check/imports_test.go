...
import "github.com/rimsky-ai/rimsky-core/lib/protocols/proto/v1/gen"
...
import "github.com/rimsky-ai/rimsky-core/lib/foundation/locks"
...
import (
	...
	// some comment
	"github.com/rimsky-ai/rimsky-core/lib/protocols/proto/v1/gen"
	"github.com/rimsky-ai/rimsky-core/lib/foundation/cascade" // trailing comment
)
...
func TestImportToRepoPath(t *testing.T) {
	cases := []struct {
		...
		{"github.com/rimsky-ai/rimsky-core/lib/foundation", "foundation", true},
		{"github.com/rimsky-ai/rimsky-core/lib/foundation/cascade", "foundation/cascade", true},
		{"github.com/rimsky-ai/rimsky-core/lib/protocols/proto/v1/gen", "protocols/proto/v1/gen", true},
