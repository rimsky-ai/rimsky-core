...
// Client wraps a generated gRPC NodeExecutorClient for rimsky's supervisor.
...
func NewGRPCClient(endpoint Endpoint) (Client, error) {
	...
	return &grpcClient{conn: conn, api: genv1.NewNodeExecutorClient(conn)}, nil
}
