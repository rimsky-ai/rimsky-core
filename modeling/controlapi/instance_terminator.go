...
// rimsky_lifecycle_idempotency rows, then fires OnInstanceTerminated to
...
// rimsky_lifecycle_idempotency rows at scope='instance' and fires
...
// recorded rimsky_lifecycle_idempotency rows for the instance, calls
