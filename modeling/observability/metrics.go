...
// code in foundation/integration, modeling/scheduler, and
// modeling/controlapi can call without importing prometheus directly —
...
func NewMetricsRegistry() *MetricsRegistry {
	...
	m := &MetricsRegistry{
		...
		DispatchQueueDepth: prometheus.NewGauge(
			prometheus.GaugeOpts{Name: "rimsky_dispatch_queue_depth", Help: "Pending worker_request rows awaiting dispatch."},
		),
