...
func LoadConfig() Config {
	return Config{
		GRPCPort:         envInt("RIMSKY_PROXY_GRPC_PORT", ports.HostDaemonProxyDaemonFacing),
		ServiceGRPCPort:  envInt("RIMSKY_PROXY_SERVICE_GRPC_PORT", ports.HostDaemonProxyServiceFacing),
