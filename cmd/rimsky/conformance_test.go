...
var conformanceSubcommands = []struct {
...
}{
	{
		...
		flags:   []string{"endpoint", "transport", "require-stub-mode", "scenarios", "skip", "timeout", "check-observability", "retention-test-seconds", "check-lifecycle", "callback-bind", "callback-host"},
