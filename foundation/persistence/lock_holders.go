...
// LockHolderRow mirrors a row of rimsky_claim_handle.
...
// LockHolderInsertInput is the per-row input for Insert.
...
// LockHoldersStore is the rimsky_claim_handle accessor exposed on Store.
