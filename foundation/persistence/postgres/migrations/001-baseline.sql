...
CREATE TABLE IF NOT EXISTS rimsky_nodes (
    ...
    -- graph/node/subscription_edges.go) drives cascade walks. The retired
    -- `dependencies UUID[]` column was removed in the 2026-05-14
    -- subscription-cascade resolution.
