...
(`lib/protocols/proto/v1/executor.proto`); `stub` is a test double, not a
starting point.

## Two primary uses

1. **`test/support/executors/stub/stubtest/`** — the in-process wrapper used by
