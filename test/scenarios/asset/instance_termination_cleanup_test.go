...
//
// At instance termination, runtime.ReleaseHeldDurableClaims walks
// held_durable=TRUE rows and calls ClaimProducer.Release on each;
// the per-claim report carries success / failure counts.
//
