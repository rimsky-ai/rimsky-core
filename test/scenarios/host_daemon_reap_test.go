...
func TestHostDaemonReapOnRunScopeTerminal(t *testing.T) {
	...
	awaited.Until(t, "the daemon to reap the spawned child on OnRunScopeTerminal and write its termination log", func() bool {
