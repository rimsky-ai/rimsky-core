...
// success-event tx.
func ProcessSchedules(ctx context.Context, sb persistence.Tables, disp MessageDispatcher, clock shared.Clock, log shared.Logger) (int, error) {
...
func lookupInstanceForNode(ctx context.Context, sb persistence.Tables, nodeID shared.UUID) *shared.UUID {
	var out *shared.UUID
	_ = sb.Transaction(ctx, func(ctx context.Context, tx persistence.Tx) error {
...
func appendDispatchFailed(ctx context.Context, sb persistence.Tables, nodeID shared.UUID, instancePtr *shared.UUID, cause error) {
	_ = sb.Transaction(ctx, func(ctx context.Context, tx persistence.Tx) error {
		return sb.Events().Append(ctx, persistence.EventAppendInput{
